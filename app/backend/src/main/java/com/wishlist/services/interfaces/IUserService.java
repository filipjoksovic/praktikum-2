...
public interface IUserService {
    ...
    TokenRefreshResponseDTO refreshTokenFunction(TokenRefreshRequestDTO tokenRefreshRequestDTO) throws NoRefreshTokenException, UserLoginException, RefreshTokenHasExpiredException;
